export function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      <section>
        <h1 className="text-xl font-bold text-slate-900">About PharmaOps Copilot</h1>
      ...
      <section>
        <h2 className="text-base font-semibold text-slate-900">How the agent is designed</h2>
      ...
      <section>
        <h2 className="text-base font-semibold text-slate-900">Cognite mapping</h2>
        <p className="mt-2 text-sm text-slate-700">
